...
export default function Footer() {
    ...
    <footer >
        ...
        <div>
        <hr className="lg:mt-4 border-gray-400 mb-2 " />
        <div className="text-sm font-light flex flex-col md:flex-row justify-between lg:ml-10 text-gray-400">
            ...
            2023 | XBeat. All Rights Reserved. Built by | Gulshan Songara
            </h1>
            <div className="flex mt-4 md:mt-0 lg:ml-10 text-2xl mr-14">
                <h1 className="pt-2 p-4 pl-6"><BiLogoFacebook/></h1>
                <h1 className="pt-2 p-4 pl-6 "><BiLogoTwitter/></h1>
                <h1 className="pt-2 p-4 pl-6 "><BiLogoInstagram/></h1>
                <h1 className="pt-2 p-4 pl-6 "><BiLogoLinkedin/></h1>
            </div>
        </div>
        </div>
    </footer>
