...
export default function Register() {
    ...
    return (
        <div className="fixed h-screen flex items-center justify-center lg:mt-20 bg-black text-white bg-opacity-50 z-20">
            {/* <ToastContainer /> */}
            <div className="rounded-lg my-20 h-fit shadow-lg w-screen">
                <div className="flex flex-col h-screen items-center justify-center lg:pr-10 lg:pl-20 lg:mb-10 mr-auto ml-auto
        xl:px-5 lg:flex-row">
            <div className="flex flex-col h-screen items-center justify-center lg:pb-40 pt-40 mb-10 lg:pl-10 lg:flex-row ">
                <div className="lg:w-76 h-[800px] lg:mt-20 w-76 flex justify-center">
                    <div className="flex flex-col items-start justify-start pt-2 pr-10 pb-10 pl-10 bg-rd shadow-2xl 
              relative z-10">
                ...
                Signup
                                ...
                                <p className="w-full text-lg font-light text-left text-white">
                                Login
                                </p>
                                </div>
                <form className="w-full mt-10 mr-0 mb-5 ml-0 relative space-y-8 sm:max-w-full md:max-w-full sm:w-full">
